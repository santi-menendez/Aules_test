...
<tr>
	...
	<p align="center"><form>
		...
		<input type="button" value="&nbsp;&nbsp;&nbsp;&nbsp;Generar PDF&nbsp;&nbsp;&nbsp;&nbsp;" onClick="javascript:finestraTotal('gen_pdf_vaixell_minina.php?data_reserva={DATA_RESERVA}&data_final={DATA_FINAL}&qui={QUI}&motiu={MOTIU}&hora_inici={HORA_INICI}&hora_final={HORA_FINAL}&patro={ASSIG}&dni_patro={DNI_PATRO}&titulacio_patro={TITULACIO_PATRO}&altres=$altres');javascript:window.close()">
	</form>
	</p>
	</center>
	</td>
