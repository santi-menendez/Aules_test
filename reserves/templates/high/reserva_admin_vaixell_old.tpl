...
<tr><td>
	...
	<table cellpadding="3">
		...
		<tr><td align="right" class="fgNavy">{E_HORA_INICI}&nbsp;</td><td>{FRANGES_HORARIES_INICI}</td><td align="right" class="fgNavy">{E_HORA_FINAL}&nbsp;</td><td>{FRANGES_HORARIES_FINAL}</td></tr>
