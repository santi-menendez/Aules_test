...
<tr>
	...
	<table width="90%" cellpadding="0" cellspacing="5" border="0">
		...
		<tr><td nowrap class="fgNavy" align="right"><b>{E_ASSIG}</b>&nbsp;</td><td width="100%">{ASSIG}</td></tr>
		<tr><td nowrap class="fgNavy" align="right"><b>{E_MOTIU}</b>&nbsp;</td><td width="100%">{MOTIU}</td></tr>
		<tr><td nowrap class="fgNavy" align="right"><b>{E_PROF}</b>&nbsp;</td><td width="100%">{PROF}</td></tr>
	</table>
	<p>
