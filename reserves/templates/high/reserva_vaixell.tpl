...
<tr><td>
	...
	<table cellpadding="3">
		...
		<tr><td align="right" class="fgNavy">{E_DATA_FINAL}:</td><td><b>{DATA}</b></td></tr>
		...
		<tr>
				...
				<td><select name='motiu'>
					...
					<option value="Sortida per pr&agrave;ctiques docents">Sortida per pr&agrave;ctiques docents</option>
	...
	<input type=hidden name='data_final' value='{DATA}'>
