...
<tr><td>
	...
	<table cellpadding="3">
		...
		<tr><td align="right" class="fgNavy">{E_ASSIG}&nbsp;</td><td><input type=text name='assig' size=30><br><small><b>(Nom&eacute;s codi de l'assignatura en cas de doc&egrave;ncia reglada)</b></small></td></tr>
		<tr><td align="right" class="fgNavy">{E_MOTIU}&nbsp;</td><td><input type=text name='motiu' size=30><br></td></tr>
		<!--<tr>
