...
include "./config.php";
   ...
   echo "<html>
	...
	<table border=\"0px\"> \n";
	    ...
	    echo "<tr><td width=\"37%\"><b>Nom del Patró responsable del iot:</b></td><td>  ".$patro."</td></tr>\n";
	    echo "<tr><td width=\"37%\"><b>Títol igual o superior a Patró de iot:</b></td><td> SI</td></tr>\n";
	    echo "<tr><td width=\"37%\"><b>Nº total d'embarcats igual o inferior a 12:</b></td><td> SI</td></tr>\n";
