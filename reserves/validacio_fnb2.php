...
if ($dom!=""):
	...
	if (isset($_POST['user']) && isset($_POST['pass'])) {
		...
		//if (@ldap_bind($ds, $login_fdn2, $password)){
		if (ldap_bind($ds, $login_fdn, $password_ldap_adm_fnb)){
			//Consultem els camps que ens calen
			$searchBase = "ou=fnb,dc=upc,dc=es";
			$nomes_em_cal=array("cn","mail","employeeType","displayName","o","givenname","sn1","sn","userpassword","uid");
			$filtre = "cn=".$login."";
...
//print_r($information[0]);exit;
			...
			if ($information['count']==1):
				...
				$pac_pas=$information[0]['employeetype'][0];
				$dept=$information[0]['o'][0];
