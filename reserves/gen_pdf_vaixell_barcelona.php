...
$filename="pdf_vaixell_barcelona";
   $var = "<html>
	 <head><title></title>
	 </head>
	 <body>";
		$var .= "<strong><h1>Formulari de reserva del Vaixell BARCELONA</h1></strong>\n";
		...
		$var .= "<tr><td width=\"80%\">Nom i Cognoms</td><td width=\"20%\">DNI</td></tr>\n";
			...
			$var .= "<tr><td width=\"70%\" height=\"20px\"> 1.-</td><td width=\"30%\">&nbsp;</td></tr>\n";
			$var .= "<tr><td width=\"70%\" height=\"20px\"> 2.-</td><td width=\"30%\">&nbsp;</td></tr>\n";
			$var .= "<tr><td width=\"70%\" height=\"20px\"> 3.-</td><td width=\"30%\">&nbsp;</td></tr>\n";
			$var .= "<tr><td width=\"70%\" height=\"20px\"> 4.-</td><td width=\"30%\">&nbsp;</td></tr>\n";
			$var .= "<tr><td width=\"70%\" height=\"20px\"> 5.-</td><td width=\"30%\">&nbsp;</td></tr>\n";
			$var .= "<tr><td width=\"70%\" height=\"20px\"> 6.-</td><td width=\"30%\">&nbsp;</td></tr>\n";
			$var .= "<tr><td width=\"70%\" height=\"20px\"> 7.-</td><td width=\"30%\">&nbsp;</td></tr>\n";
			$var .= "<tr><td width=\"70%\" height=\"20px\"> 8.-</td><td width=\"30%\">&nbsp;</td></tr>\n";
			$var .= "<tr><td width=\"70%\" height=\"20px\"> 9.-</td><td width=\"30%\">&nbsp;</td></tr>\n";
			$var .= "<tr><td width=\"70%\" height=\"20px\"> 10.-</td><td width=\"30%\">&nbsp;</td></tr>\n";
			$var .= "<tr><td width=\"70%\" height=\"20px\"> 11.-</td><td width=\"30%\">&nbsp;</td></tr>\n";
			$var .= "</table> \n";
		$var .= "</table> \n";
