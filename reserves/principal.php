...
PintarMenu();
	...
	switch($op){
		...
		case 52:	// Obre una finestra per a realitzar una reserva puntual del Vaixell
					FerReservaPuntualVaixell($dia,$mes,$any,$recurs,$hora_inici);
					break;
		...
		case 57:	// Reserves periodiques
					if(!$_1 && !$_2 && !$_3 && !$_4 && !$_5 && !$_6 && !$_7):
						...
						if($resultat==0):
							...
							$i--;
							while($i>=0):
								accept_periodic_reservation_vaixell($data_inici,$data_final,$t[$i],$recurs,$qui,$motiu,$hora_inici,$hora_final,$assig,0,$projector);
								$i--;
							endwhile;
						else:
							//no es poden realitzar
							accept_periodic_reservation_vaixell($data_inici,$data_final,$t[$i-1],$recurs,$qui,$motiu,$hora_inici,$hora_final,$assig,0,$projector);
						endif;
					endif;
					//accept_periodic_reservation($data_inici,$data_final,$dia,$recurs,$qui,$motiu,$hora_inici,$hora_final,0);
					break;
