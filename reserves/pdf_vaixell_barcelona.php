...
$altres=utf8_decode($_REQUEST["altres"]);
   $var = "<html>
	 ...
	 <body>
	<table border=\"0px\"> \n";
		$var = "<tr><td><img src=\"/images/logotip/0280lFNB.gif\" width=\"300\" border=\"0\"></td></tr>\n";
		$var = "<tr><td><center><strong><h1>Formulari de reserva del Vaixell BARCELONA</h1></strong></center></td></tr>\n";
		$var = "</table> \n";
		...
		$var = "<tr><td width=\"37%\"><b>Professor responsable de la reserva:</b></td><td>  ".utf8_decode($qui)."</td></tr>\n";
	    $var = "<tr><td width=\"37%\"><b>Nom i DNI del Patr&oacute;/ona responsable:</b></td><td>  ".utf8_decode($patro."&nbsp;-&nbsp;".$dni_patro)."</td></tr>\n";
	    $var = "<tr><td width=\"37%\"><b>T&iacute;tol igual o superior a Patr&oacute; de iot:</b></td><td> SI&nbsp;-&nbsp;".utf8_decode($titulacio_patro)."</td></tr>\n";
	    $var = "<tr><td width=\"37%\"><b>N&deg; total d'embarcats igual o inferior a 12:</b></td><td> SI</td></tr>\n";
		$var = "<tr><td width=\"37%\"><b>Motiu de la reserva:</b></td><td>  ".utf8_decode($motiu)."</td></tr>\n";
		$var = "<tr><td width=\"37%\"><b>Assignatura/Activitat:</b></td><td>  ".utf8_decode($altres)."</td></tr>\n";
		$var = "</table> \n";
		...
		$var = "<tr><td width=\"80%\">Nom i Cognoms</td><td width=\"20%\">DNI</td></tr>\n";
			...
			$var = "<tr><td width=\"70%\">1.-</td><td width=\"30%\">&nbsp;</td></tr>\n";
			$var = "<tr><td width=\"70%\">2.-</td><td width=\"30%\">&nbsp;</td></tr>\n";
			$var = "<tr><td width=\"70%\">3.-</td><td width=\"30%\">&nbsp;</td></tr>\n";
			$var = "<tr><td width=\"70%\">4.-</td><td width=\"30%\">&nbsp;</td></tr>\n";
			$var = "<tr><td width=\"70%\">5.-</td><td width=\"30%\">&nbsp;</td></tr>\n";
			$var = "<tr><td width=\"70%\">6.-</td><td width=\"30%\">&nbsp;</td></tr>\n";
			$var = "<tr><td width=\"70%\">7.-</td><td width=\"30%\">&nbsp;</td></tr>\n";
			$var = "<tr><td width=\"70%\">8.-</td><td width=\"30%\">&nbsp;</td></tr>\n";
			$var = "<tr><td width=\"70%\">9.-</td><td width=\"30%\">&nbsp;</td></tr>\n";
			$var = "<tr><td width=\"70%\">10.-</td><td width=\"30%\">&nbsp;</td></tr>\n";
			$var = "<tr><td width=\"70%\">11.-</td><td width=\"30%\">&nbsp;</td></tr>\n";
			$var = "</table> \n";
		$var = "</table> \n";
		...
		$var = "<tr><td width=\"50%\"><td width=\"50%\">( ) Desfavorable. Especificar:</td></tr>\n";
		$var = "</table> \n";
			$var = "<table border=\"0px\"> \n";
		...
		$var = "<tr><td width=\"50%\"><td width=\"50%\">Final:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;hores</td></tr>\n";
		$var = "</table> \n";
		
		$var = "<table border=\"0px\"> \n";
		$var = "<tr><td><strong><h1></h1></strong>&nbsp;</td></tr>\n";
		$var = "<tr><td><b>Signatura del patr&oacute; i del sol&middot;licitant. Barcelona a&nbsp;&nbsp;&nbsp;&nbsp;de&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;de&nbsp;&nbsp;&nbsp;&nbsp;20__</b></td></tr>\n";
		$var = "</table> \n";

			$var = "<table border=\"1px\"> \n";
			$var = "<tr><td width=\"50%\" height=\"10%\" align=\"center\" valign=\"top\">Nom i Cognoms del Sol&middot;licitant</td><td width=\"50%\" height=\"10%\" align=\"center\" valign=\"top\">Nom i Cognoms del Patr&oacute;/ona</td></tr>\n";
			$var = "</table></body></html> \n";
		$var = "<table border=\"0px\"> \n";
...
$pdf->SetHeaderData(PDF_HEADER_LOGO_FNB_UPC, PDF_HEADER_LOGO_WIDTH, PDF_HEADER_TITLE_CCE, PDF_HEADER_STRING);
